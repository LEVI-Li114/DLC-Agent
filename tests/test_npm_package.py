...
class NpmPackageTest(unittest.TestCase):
    ...
    def test_launcher_supports_https_gateway(self):
        ...
        self.assertIn('require("node:https")', script)
        self.assertIn("transport.request", script)
        self.assertIn('accept: "application/json, text/event-stream"', script)
        self.assertIn("dlc-mcp-gateway.crt", script)
